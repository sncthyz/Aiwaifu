...
pertanyaan = {
    ...
    # ===== GOMBALAN / PUJIAN (Lebih dari 150 keyword) =====
...
def reset():
    ...
    return render_template("index.html", history = [], result=None)
...
def index():
    ...
    return render_template("index.html", history = session["history"], result=result)
